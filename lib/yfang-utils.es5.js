 ...
 * @ignore
 */
var newProvince = Object.keys(provinces).reduce(function (result, key) {
    result[provinces[key]] = key;
    return result;
}, {});
/**
 * @ignore
 */
var newDataMap = Object.keys(dataMap).reduce(function (result, key) {
    result[dataMap[key]] = key;
    return result;
}, {});
/**
 * @export 获取省份字符串列表
...
function getProvinces() {
    return Object.keys(newProvince);
}
/**
 * @export 获取省份列表详情
 * @returns
 */
function getProvincesDetail() {
    return Object.keys(newProvince).map(function (key) {
        return {
            label: key,
            value: newProvince[key]
        };
    });
}
/**
...
function getCitys(province) {
    var provinceId = newProvince[province];
    if (!provinceId)
        return [];
    var result = [];
    Object.keys(dataMap).forEach(function (key) {
        if (key.slice(0, 2) === provinceId.slice(0, 2) && key.slice(-2) === '00') {
 ...
 * @returns
 */
function getCitysDetail(province, proId) {
    var provinceId = proId || newProvince[province];
    if (!provinceId)
        return [];
    var result = [];
    Object.keys(dataMap).forEach(function (key) {
...
function getDistricts(city) {
    var cityId = newDataMap[city];
    if (!cityId)
        return [];
    var result = [];
    Object.keys(dataMap).forEach(function (key) {
        if (key.slice(0, 4) === cityId.slice(0, 4) && key.slice(-2) !== '00') {
            result.push(dataMap[key]);
        }
    });
    return result;
 ...
 * @returns
 */
function getDistrictsDetail(city, cid) {
    var cityId = cid || newDataMap[city];
    if (!cityId)
        return [];
    var result = [];
    Object.keys(dataMap).forEach(function (key) {
...
//# sourceMappingURL=yfang-utils.es5.js.map
